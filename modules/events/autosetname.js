...
var memJoin = event.logMessageData.addedParticipants.map(info => info.userFbId)
	for (let idUser of memJoin) {
		...
		const pathData = join("./modules/events","cache", "autosetname.json");
	...
	return api.sendMessage(`✨Thành Viên vào box sẽ được Set Biệt Danh tạm thời theo Quy Định của box.\n✨Có thể đổi lại`, threadID, event.messageID)
}