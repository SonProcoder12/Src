...
if(!isNaN(args[0])) {
        ...
        if (coins > balance) return api.sendMessage('Số Coins Bạn Chuyển Lớn Hơn Số Coins Bạn Đang Có!',threadID,messageID);
        else {
    ...
    fs.writeFileSync(path, imageBuffer);
          return api.sendMessage(`Vui Lòng Đợi Bot Xử Lí GD`, event.threadID, async (err, info) => {
